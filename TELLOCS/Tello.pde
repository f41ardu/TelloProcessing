 ...
 public class Tello
    {
        ...
        public void updateDeligate(int cmdId);
        public static event updateDeligate onUpdate;
        public  void connectionDeligate(ConnectionState newState);
        public static event connectionDeligate onConnection;
        public  void videoUpdateDeligate(byte[] data);
...
//                        break;
        ...
        public  float[] getControllerDeligate();
